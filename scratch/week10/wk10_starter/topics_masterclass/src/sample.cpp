...
//! TASK 1
//!
//! We need to create the subscriber for sensor_msgs::msg::LaserScan and topic name orange/laserscan and use laser_callback as the 
//! callback function. 
    ...
    : Node("laser_example")
{
  ...
  //We create a thread of execution here independent of the callbacks
...
//! Keep below piece of code in callback function
...
void PfmsSample::process()
{
    while (rclcpp::ok()) {
        ...
        //! TASK 2
        //!
        //! use the robot pose and closest point and transfer it to the workd coordinates rather than 
