...
width_(width), height_(height)
{
    ...
    if (diff<1e-6) { //PROBING Q - Is this the best way to do floating point comparsion????
        description_ = "square";
    } else {
...
void Rectangle::setHeightWidth(double width, double height)
{
    ...
    // Given we have a function to set the member variables, we also can leverage this function to set any
