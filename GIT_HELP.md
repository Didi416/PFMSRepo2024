...
Once you have accepted the classroom invite with your git account, a new git repository will be created called  `pfms-2024a-<username>` which contains a clone of the subject material. Github provides a web interface where you can manage your git repository at: `https://github.com/41012/pfms-2024a-<username>`. At any point in time your web interface and your local repository could be different, read on to understand why and how to manage this.
...
```
git clone git@github.com:41012/pfms-2024a-<username>.git
```
After executing this, you will find that a folder pfms-2024a-<username> is created, this is your local repository. It has your code, with all files you have pushed to date that are specific to you.
